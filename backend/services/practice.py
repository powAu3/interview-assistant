...
根据候选人简历和岗位要求，生成 {count} 道面试题（由浅入深）。

## 候选人简历
{resume}

## 要求
1. 前 1-2 题：基于简历中的项目经历或技术栈提问
2. 中间题目：{language} 技术基础和核心概念
3. 最后 1-2 题：系统设计或综合开放性问题
4. 每题分类为 project / basic / design / comprehensive

严格输出 JSON 数组，不要其他内容：
[{{"id": 1, "question": "...", "category": "project"}}, ...]"""

QUESTION_GEN_NO_RESUME = """你是一位资深的{position}技术面试官。
生成 {count} 道 {language} 方向的面试题（由浅入深）。

## 要求
1. 前 2 题：基础概念
2. 中间题目：核心原理和最佳实践
3. 最后 1-2 题：系统设计或综合开放性问题
4. 每题分类为 basic / design / comprehensive
